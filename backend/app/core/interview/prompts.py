...
SYSTEM_QUESTION_GEN = (
    ...
    "IMPORTANT: Always respond in Chinese (中文). The question and all text must be in Chinese. "
...
SYSTEM_ANSWER_SCORE = (
    ...
    "IMPORTANT: Always write feedback and analysis in Chinese (中文). "
...
SYSTEM_REPORT_GEN = (
    ...
    "IMPORTANT: Always write the entire report in Chinese (中文), including feedback, suggestions, and dimension descriptions. "
    'Respond in JSON: {"overall_score": 0-100, '
    '"radar": {"communication": 0-100, ...}, '
    '"feedback": {"strengths": [], "weaknesses": [], "suggestions": "..."}}'
)


def build_question_prompt(role_name: str, questions_so_far: int, qa_history=None) -> str:
...
def build_score_prompt(question: str, answer: str, expected_points=None) -> str:
...
def build_report_prompt(qa_pairs: list) -> str:
